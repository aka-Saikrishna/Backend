...
const changeCurrentPassword = asyncHandler(async (req, res) => {
 ...
 if(!(newPassword === confirmPassword)){
  ...
  return res
  .status(200)
  .json(new ApiResponse(200, {}, "Password "))
...
const updateCurrentUserDetails = asyncHandler(async (req, res) => {
 ...
 const user = await User.findById(
    ...
    {
      $set: {
        // fullname: fullname // we can write in this e=way also
        fullname,
        email
      }
    },
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateCurrentUserDetails, updateUserAvatar, updateUserCoverImage
 };
